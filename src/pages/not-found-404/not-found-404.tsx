...
export const NotFound404: React.FC = () => {
    ...
    return (
        <div className={classes.NotFound404}>
            <div className={classes.Link} onClick={handleRouteBack}>
                        ...
                        <div className={classes.RowBlock}>
                            ...
                            >
                                <g id="OBJECTS">
                                    ...
                                    <g ref={zeroRef} className={classes.Zero}>
                                        <path
                                            id="Vector_25"
